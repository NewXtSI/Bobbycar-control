...
void ui_task(void* param) {
    ...
    // style_rideinfo1_bg_img_main_main_default
    ...
    lv_style_set_img_recolor(&style_rideinfo1_bg_img_main_main_default,
    ...
    lv_obj_add_style(RideInfo1_bg_img,
                     &style_rideinfo1_bg_img_main_main_default,
    ...
    // Write style state: LV_STATE_DEFAULT for
    // style_overview_gauge_bg_img_main_main_default
    ...
    lv_style_set_img_recolor(&style_overview_gauge_bg_img_main_main_default,
                             lv_color_make(0xff, 0xff, 0xff));
    lv_style_set_img_recolor_opa(&style_overview_gauge_bg_img_main_main_default,
                                 0);
    lv_style_set_img_opa(&style_overview_gauge_bg_img_main_main_default, 255);
    lv_obj_add_style(Overview_gauge_bg_img,
                     &style_overview_gauge_bg_img_main_main_default,
                     LV_PART_MAIN | LV_STATE_DEFAULT);
    ...
    // Write style state: LV_STATE_DEFAULT for
    // style_overview_gaugel_img_main_main_default
    ...
    lv_style_set_img_recolor(&style_overview_gaugel_img_main_main_default,
                             lv_color_make(0xff, 0xff, 0xff));
    lv_style_set_img_recolor_opa(&style_overview_gaugel_img_main_main_default,
                                 0);
    lv_style_set_img_opa(&style_overview_gaugel_img_main_main_default, 255);
    lv_obj_add_style(Overview_gaugeL_img,
                     &style_overview_gaugel_img_main_main_default,
                     LV_PART_MAIN | LV_STATE_DEFAULT);
    ...
    // Write style state: LV_STATE_DEFAULT for
    // style_overview_gaugen_img_main_main_default
    ...
    lv_style_set_img_recolor(&style_overview_gaugen_img_main_main_default,
                             lv_color_make(0xff, 0xff, 0xff));
    lv_style_set_img_recolor_opa(&style_overview_gaugen_img_main_main_default,
                                 0);
    lv_style_set_img_opa(&style_overview_gaugen_img_main_main_default, 255);
    lv_obj_add_style(Overview_gaugeN_img,
                     &style_overview_gaugen_img_main_main_default,
                     LV_PART_MAIN | LV_STATE_DEFAULT);
    ...
    // Write style state: LV_STATE_DEFAULT for
    // style_overview_needle_img_main_main_default
    ...
    lv_style_set_img_recolor(&style_overview_needle_img_main_main_default,
                             lv_color_make(0xff, 0xff, 0xff));
    lv_style_set_img_recolor_opa(&style_overview_needle_img_main_main_default,
                                 0);
    lv_style_set_img_opa(&style_overview_needle_img_main_main_default, 255);
    lv_obj_add_style(Overview_needle_img,
                     &style_overview_needle_img_main_main_default,
                     LV_PART_MAIN | LV_STATE_DEFAULT);
    ...
    // Write style state: LV_STATE_DEFAULT for
    // style_overview_battery_line_img_main_main_default
    ...
    lv_style_set_img_recolor(&style_overview_battery_line_img_main_main_default,
                             lv_color_make(0xff, 0xff, 0xff));
    lv_style_set_img_recolor_opa(
        &style_overview_battery_line_img_main_main_default, 0);
    lv_style_set_img_opa(&style_overview_battery_line_img_main_main_default,
                         255);
    lv_obj_add_style(Overview_battery_line_img,
                     &style_overview_battery_line_img_main_main_default,
                     LV_PART_MAIN | LV_STATE_DEFAULT);
    ...
    // Write style state: LV_STATE_DEFAULT for
    // style_overview_battery_icon_main_main_default
    ...
    lv_style_set_img_recolor(&style_overview_battery_icon_main_main_default,
                             lv_color_make(0xff, 0xff, 0xff));
    lv_style_set_img_recolor_opa(&style_overview_battery_icon_main_main_default,
                                 0);
    lv_style_set_img_opa(&style_overview_battery_icon_main_main_default, 255);
    lv_obj_add_style(Overview_battery_icon,
                     &style_overview_battery_icon_main_main_default,
                     LV_PART_MAIN | LV_STATE_DEFAULT);
    ...
    // Write style state: LV_STATE_DEFAULT for
    // style_overview_battery_arc_main_main_default
    ...
    lv_style_set_bg_color(&style_overview_battery_arc_main_main_default,
                          lv_color_make(0x09, 0x80, 0xff));
    lv_style_set_bg_grad_color(&style_overview_battery_arc_main_main_default,
                               lv_color_make(0x00, 0x80, 0xff));
    lv_style_set_bg_grad_dir(&style_overview_battery_arc_main_main_default,
                             LV_GRAD_DIR_VER);
    ...
    lv_style_set_arc_color(&style_overview_battery_arc_main_main_default,
                           lv_color_make(0x00, 0x80, 0xff));
    lv_style_set_arc_width(&style_overview_battery_arc_main_main_default, 5);
    lv_obj_add_style(Overview_battery_arc,
                     &style_overview_battery_arc_main_main_default,
                     LV_PART_MAIN | LV_STATE_DEFAULT);

    // Write style state: LV_STATE_DEFAULT for
    // style_overview_battery_arc_main_indicator_default
    ...
    lv_style_set_arc_color(&style_overview_battery_arc_main_indicator_default,
                           lv_color_make(0x21, 0x95, 0xf6));
    lv_style_set_arc_width(&style_overview_battery_arc_main_indicator_default,
                           5);
    lv_obj_add_style(Overview_battery_arc,
                     &style_overview_battery_arc_main_indicator_default,
    ...
    // Write style state: LV_STATE_DEFAULT for
    // style_overview_battery_arc_main_knob_default
    ...
    lv_style_set_bg_color(&style_overview_battery_arc_main_knob_default,
                          lv_color_make(0x00, 0x80, 0xff));
    lv_style_set_bg_grad_color(&style_overview_battery_arc_main_knob_default,
                               lv_color_make(0x00, 0x80, 0xff));
    lv_style_set_bg_grad_dir(&style_overview_battery_arc_main_knob_default,
                             LV_GRAD_DIR_VER);
    ...
    lv_obj_t* Overview_gauge_label_1 = lv_label_create(mainscreen);
    lv_obj_set_pos(Overview_gauge_label_1, 70 / 2, 110 / 2);
    lv_obj_set_size(Overview_gauge_label_1, 100 / 2, 40 / 2);
    lv_label_set_text(Overview_gauge_label_1, "0");
    lv_label_set_long_mode(Overview_gauge_label_1, LV_LABEL_LONG_WRAP);
    ...
    if (style_overview_gauge_label_1_main_main_default.prop_cnt > 1)
        lv_style_reset(&style_overview_gauge_label_1_main_main_default);
    else
        lv_style_init(&style_overview_gauge_label_1_main_main_default);
    lv_style_set_radius(&style_overview_gauge_label_1_main_main_default, 0);
    lv_style_set_bg_color(&style_overview_gauge_label_1_main_main_default,
                          lv_color_make(0xff, 0xff, 0xff));
    lv_style_set_bg_grad_color(&style_overview_gauge_label_1_main_main_default,
                               lv_color_make(0xff, 0xff, 0xff));
    lv_style_set_bg_grad_dir(&style_overview_gauge_label_1_main_main_default,
                             LV_GRAD_DIR_VER);
    lv_style_set_bg_opa(&style_overview_gauge_label_1_main_main_default, 0);
    lv_style_set_text_color(&style_overview_gauge_label_1_main_main_default,
                            lv_color_make(0xff, 0xff, 0xff));
    lv_style_set_text_font(&style_overview_gauge_label_1_main_main_default,
                           &lv_font_montserrat_22);
    //	lv_style_set_text_font(&style_overview_gauge_label_1_main_main_default,
    //&lv_font_montserratMedium_42);
    lv_style_set_text_letter_space(
        &style_overview_gauge_label_1_main_main_default, 1);
    lv_style_set_pad_left(&style_overview_gauge_label_1_main_main_default, 0);
    lv_style_set_pad_right(&style_overview_gauge_label_1_main_main_default, 0);
    lv_style_set_pad_top(&style_overview_gauge_label_1_main_main_default, 0);
    lv_style_set_pad_bottom(&style_overview_gauge_label_1_main_main_default, 0);
    lv_obj_add_style(Overview_gauge_label_1,
                     &style_overview_gauge_label_1_main_main_default,
                     LV_PART_MAIN | LV_STATE_DEFAULT);

    // Write codes Overview_gauge_label_2
    lv_obj_t* Overview_gauge_label_2 = lv_label_create(mainscreen);
    lv_obj_set_pos(Overview_gauge_label_2, 75 / 2, 155 / 2);
    lv_obj_set_size(Overview_gauge_label_2, 100 / 2, 32 / 2);
    lv_label_set_text(Overview_gauge_label_2, "km/h");
    lv_label_set_long_mode(Overview_gauge_label_2, LV_LABEL_LONG_WRAP);
    lv_obj_set_style_text_align(Overview_gauge_label_2, LV_TEXT_ALIGN_CENTER,
                                0);

    // Write style state: LV_STATE_DEFAULT for
    // style_overview_gauge_label_2_main_main_default
    static lv_style_t style_overview_gauge_label_2_main_main_default;
    if (style_overview_gauge_label_2_main_main_default.prop_cnt > 1)
        lv_style_reset(&style_overview_gauge_label_2_main_main_default);
    else
        lv_style_init(&style_overview_gauge_label_2_main_main_default);
    lv_style_set_radius(&style_overview_gauge_label_2_main_main_default, 0);
    lv_style_set_bg_color(&style_overview_gauge_label_2_main_main_default,
                          lv_color_make(0xff, 0xff, 0xff));
    lv_style_set_bg_grad_color(&style_overview_gauge_label_2_main_main_default,
                               lv_color_make(0xff, 0xff, 0xff));
    lv_style_set_bg_grad_dir(&style_overview_gauge_label_2_main_main_default,
                             LV_GRAD_DIR_VER);
    lv_style_set_bg_opa(&style_overview_gauge_label_2_main_main_default, 0);
    lv_style_set_text_color(&style_overview_gauge_label_2_main_main_default,
                            lv_color_make(0xff, 0xff, 0xff));
    lv_style_set_text_font(&style_overview_gauge_label_2_main_main_default,
                           &lv_font_montserrat_10);
    lv_style_set_text_letter_space(
        &style_overview_gauge_label_2_main_main_default, 0);
    lv_style_set_pad_left(&style_overview_gauge_label_2_main_main_default, 0);
    lv_style_set_pad_right(&style_overview_gauge_label_2_main_main_default, 0);
    lv_style_set_pad_top(&style_overview_gauge_label_2_main_main_default, 0);
    lv_style_set_pad_bottom(&style_overview_gauge_label_2_main_main_default, 0);
    lv_obj_add_style(Overview_gauge_label_2,
                     &style_overview_gauge_label_2_main_main_default,
                     LV_PART_MAIN | LV_STATE_DEFAULT);
...
//    lv_obj_add_style(speed_arc, &style, LV_PART_MAIN);
    ...
    while (1) {
        ...
        //	lv_arc_set_bg_angles(Overview_battery_arc, 85+(uiSpeed/10),
        // 130); 	lv_arc_set_angles(Overview_battery_arc, 85+(uiSpeed/10),
        // 130);
        //        lv_arc_set_value(Overview_battery_arc, uiSpeed);
#if 0        
        if (uiSpeed > 200) {
            lv_obj_set_style_img_recolor(Overview_needle_img, lv_color_hex(0xff0000), 0);
            lv_obj_set_style_img_recolor_opa(Overview_needle_img, LV_OPA_COVER, 0);             
            lv_obj_set_style_img_recolor(Overview_gaugeN_img, lv_color_hex(0xff0000), 0);
            lv_obj_set_style_img_recolor_opa(Overview_gaugeN_img, LV_OPA_COVER, 0);             
            lv_obj_set_style_img_recolor(Overview_gaugeL_img, lv_color_hex(0xff0000), 0);
            lv_obj_set_style_img_recolor_opa(Overview_gaugeL_img, LV_OPA_COVER, 0);             
        } else {
            
            lv_obj_set_style_img_recolor_opa(Overview_needle_img, LV_OPA_TRANSP, 0);           
            lv_obj_set_style_img_recolor_opa(Overview_gaugeN_img, LV_OPA_TRANSP, 0);           
            lv_obj_set_style_img_recolor_opa(Overview_gaugeL_img, LV_OPA_TRANSP, 0);           
